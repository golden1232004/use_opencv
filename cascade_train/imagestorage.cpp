...
/** 
 * create(_filename, _winSize) load the negative file names and init the class. 
 * @param _filename  The file contains rows of negative file name. The file name is relative path.
 * @param _winSize 
 * 
 * @return 
 */
...
/** 
 * get(_img) get the next negative sample data.
 * @param _img 
 * @return 
 */
...
/** 
 * create(_filename) read the file header of the file '_filename' and prepare the memory and init
 * this class.
 * @param _filename The file header is defined like this
 *                  struct {
 *                      int count;
 *                      int vecSize;
 *                      short reserved0;
...
/** 
 * get(_img) get the next positive sample data.
 * @param _img 
 * @return Instead of CV_Error, return false. Because ecountering an EOF may be a correct phenomenal
 *         during the process of CvCascadeClassifier::fillPassedSamples(...).
 */
...
/** 
 * restart() reset the read pointer.
 */
