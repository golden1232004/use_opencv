...
// Get the coordination of the 'rect' in a integral image.
...
// Get the coordination of the 'rect' in a tilted integral image.
...
/**
 * CvParams defines a interface of IO methods, which take the responsibility of 
 * read/write from/to a file or print/scan to/from the stdout/stdin.
 */
...
public:
    ...
    std::string name;			/**< Define the element name in the XML/YML. */
};

/**
 * CvFeatureParams take two responsibilities:
 *   1. As a simple factory to create a concreate CvFeatureParams class of HAAR/LBP/HOG.
 *   2. Encapsulate two parameters used by all the features and implements the CvParams
 *      interface's methods.
 */
